...
Before implementing any backend change, the agent must explicitly identify:

* the primary backend role responsible
* whether the task is architectural, implementation, review, or security-related
* the affected backend layer (command, application, infrastructure)
