...
Before implementing any frontend change, the agent must explicitly identify:

* the primary frontend role responsible
* whether the task is architectural, UI implementation, review, or integration-related
* the affected frontend boundary (component, state, service, Tauri integration)
