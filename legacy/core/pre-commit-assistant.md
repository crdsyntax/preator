...
Before any change is committed, verify that:

* the task has a clearly assigned primary role
* the role matches the scope of the task
* no execution occurred before role selection
